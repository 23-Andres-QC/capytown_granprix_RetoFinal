...
def _imagen_a_jpeg_data_url(msg: Image, max_width: int, calidad: int = 70):
    """Ejecuta imagen a jpeg data url."""
...
class VisualizadorWeb(Node):
    def __init__(self):
        ...
        self.declare_parameter('front_lidar', 180.0)
        ...
        self.declare_parameter('fuente_yaw', 'odom')
        self.declare_parameter('topic_imu', '/imu')
        self.declare_parameter('imu_fuente', 'gyro')
        ...
        self.pos = None
        self.head = [0.0, 0.0]
        self._odom_origen = None
        self._ultimo_odom = None
        self._ultimo_yaw = None
        self.imu_yaw = None
        self._imu_yaw_int = 0.0
    ...
    def _dist_pared_atras_inicio(self):
        """Ejecuta dist pared atras inicio."""
        pts = [
            p for p in self._lidar_full
    ...
    def _detectar_paredes_lidar(self):
        """Ejecuta detectar paredes lidar."""
        detectadas = []
        segmentos = []
        regiones = [
    ...
    def _calibrar_inicio_con_lidar(self, yaw, factor_ang):
        """Ejecuta calibrar inicio con lidar."""
